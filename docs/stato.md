...
**49** ADR: 45 `Accettata`, 3 `Proposta`, 1 `Superata`.
...
**41** deleghe: 40 `Chiusa`, 0 `In corso`, 1 `Aperta`.
...
**114** markdown: 113 sotto `docs/`, più il `README.md` della radice.
