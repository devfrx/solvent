...
| --- | ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| N01 | **Il kernel è un punto singolo.** Un difetto nel Registry o nel Ledger si propaga a tutto         | prima nessun componente aveva questo potere                                                          | 545 righe con `balance/`, di cui 471 in `kernel/`; scritte da D003 a D008, testate per intero, pure, senza I/O                                                                   | basso                                                                                     |
...
| N07 | **La documentazione può disallinearsi dal codice**                                                | è il difetto classico di un set di documenti ampio: mente con autorevolezza                          | ADR append-only; deleghe che si **chiudono**; l'architettura si aggiorna nello stesso task che sposta un confine; `tests/rules/doc-links` per i collegamenti                     | **alto — è il rischio principale di questo approccio, e si è già realizzato: vedi sotto** |
