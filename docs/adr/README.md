...
bilanciamento e ci mette un **tempo**, così il rapporto diventa vero per costruzione invece che per
taratura. Va letta insieme all'[ADR 0052](0052-un-guadagno-dichiara-dove-atterra.md), che è ciò che
la rende interessante: se ogni miglioramento rientra nello stesso tempo, «quale compro?» smette di
essere un confronto fra prezzi e diventa una domanda su **in quale pozza atterrano i soldi**.
