...
flowchart TD
  ...
  D027 --> D034
  D033 --> D035["D035 · Ciò che non si dichiara lo sceglie un altro"]
  D032 --> D035
  D019 --> D036["D036 · Il pagamento è un flusso solo"]
  D023 --> D036
  D031 --> D036
  D011 --> D037["D037 · Il tempo che avanza è un'operazione del gioco"]
  D034 --> D037
...
| [D018](D018-la-scheda-di-dominio.md)                          | La scheda di dominio: la forma, e le prime tre compilate                              | 503 documentazione + 128 test | **Chiusa** |
...
| [D042](D042-il-caveau-ha-uno-spazio-e-una-scala.md)           | Il caveau ha uno spazio, e una scala invece di quattro numeri                         | 198 codice + 262 test         | **Chiusa** |
| [D043](D043-il-reddito-si-mette-in-regola.md)                 | Il reddito si mette in regola                                                         | 247 codice + 405 test         | **Chiusa** |
| [D044](D044-il-reddito-e-un-elenco-di-fonti.md)               | Il reddito è un elenco di fonti                                                       | ~450 codice + ~400 test       | **Chiusa** |
...
Eseguita il 2026-08-21, ha rispettato quella condizione — `src/` non è stato toccato — e ne ha
smentita un'altra: dichiarava «nessuna regola nuova» e ne ha prodotta una, **R19**. La domanda 6
della metà kernel afferma che nessun dominio importa un altro dominio, ed è l'unica riga della
scheda che non aveva un ADR, un invariante o un test dietro: dichiararla di review avrebbe fatto
violare a D018 il proprio invariante nella riga stessa che lo enuncia. Il test sta in
`tests/rules/domains-are-independent` e non tocca `src/`. È anche la prima delega che chiude **sotto**
il budget di documentazione, e la ragione è che la [scheda del caveau](../design/domini/vault.md)
era già scritta a metà.
...
**[D035](D035-cio-che-non-si-dichiara-lo-sceglie-un-altro.md) è la seconda delega nata da un audit**,
dopo [D016](D016-correzioni-audit.md), e le due si somigliano nella forma e non nell'esito. D016
correggeva diciassette difetti trovati nella fetta 01, uno dei quali critico e di perdita dati;
D035 ne corregge sette trovati in una codebase che nel frattempo si è messa sotto i test di regola
che [tracciabilita.md](../tracciabilita.md) elenca, e il difetto più grave che ha trovato **non si
incontra giocando**. È la misura di
quanto quei test valgano: l'audit del 2026-08-22 ha dovuto cercare dove nessun gate guarda per
trovare qualcosa, e sei reperti su nove stanno fuori da `src/`.

Le due frecce che la raggiungono sono vincoli e non cronologia: le correzioni ai documenti non
esistono prima che [D033](D033-il-bancomat-e-una-pagina.md) tolga la `home`, e la riga del registro
YAGNI non si toglie prima che [D032](D032-la-commissione-scala-il-pavimento-no.md) dichiari la
precisione che quella riga diceva mancante.
