...
| Il margine dell'asse **non attraversa lo zero** se la serie non ci scende                            | l'asse sotto zero — 2026-08-23                                                                                            | ancorare l'asse a zero, che l'ADR di D027 ha già scartato con una misura; oppure clampare nel componente che disegna, e allora la regola vive in due posti e il prossimo grafico non la eredita                  |
