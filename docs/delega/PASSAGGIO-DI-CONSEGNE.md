...
| `origin/main`            | **allineato.** Il 2026-08-23 sono stati spinti in un colpo i diciotto commit che mancavano: le due fusioni più D036. Che sia ancora vero non si scrive qui: lo dice `git rev-list --count origin/main..main`                                                                                                                                                                                                                                                    |
...
- **`main` ha D036 ed è spinto.** La delega è stata fusa con un `--ff-only`, `verify` e
  `verify:release` sono stati girati **su `main` fuso** — 83 file, 1.028 test — e poi i diciotto
  commit che mancavano sono stati spinti in un colpo. I quattro rami di lavoro sono stati cancellati
