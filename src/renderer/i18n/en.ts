...
export const en: Dictionary = {
  ...
  'atm.withdraw.breakdown': 'What happens',
  'atm.fee': 'Fee',
  'atm.confirm': 'Confirm withdrawal',
  'atm.recent.title': 'Recent operations',

  'card.tier.gold': 'Gold',
  'card.back.limit_used': 'Credit used',
  'card.back.credit_score': 'Credit score',
