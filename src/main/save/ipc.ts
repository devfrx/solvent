...
/**
 * I tre canali del confine, e l'ordine in cui le cose succedono dietro di loro
 * (docs/design/flusso-salvataggio.md).
 *
 * `electron` entra qui **solo come tipo**: `IpcMain` arriva per parametro. Non è pignoleria di
 * testabilità — è ciò che permette di provare il caricamento e il salvataggio con file veri
 * senza avviare Electron, che è l'unica forma in cui questi test verranno eseguiti a ogni
 * commit invece che una volta.
 */
